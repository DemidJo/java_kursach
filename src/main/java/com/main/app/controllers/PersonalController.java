...
public class PersonalController {
    ...
    public String personal(Model model) {
        ...
        if (tasks.size() == 0) model.addAttribute("error", "Нет добавленного оборудования");
        if (tasksExec.size() == 0) model.addAttribute("errorExec", "Нет добавленного оборудования");
        if (tasksAuthor.size() == 0) model.addAttribute("errorAuthor", "Нет добавленного оборудования");
